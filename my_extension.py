...
@knext.input_table(name="Input Data", description="Needs a number column 'column1'")
@knext.input_table(
    name="Input Data 2", description="Also needs a number column 'column1'"
)
@knext.output_table(
    name="Output Data", description="Table of first input table with a new column"
)
class TemplateNode:
    """

    It adds the values the input columns 'column1' of both tables, multiplies it with the double_param
    and appends the resulting column as 'column2' to the first table.
    """
